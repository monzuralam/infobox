...
var Edit = function Edit(_ref) {
  ...
  var boxWrapperStyle = {
    ...
    padding: "".concat(paddingTop >= 0 ? paddingTop : 30).concat(paddingUnit, " ").concat(paddingRight >= 0 ? paddingRight : 70).concat(paddingUnit, " ").concat(paddingBottom >= 0 ? paddingBottom : 30).concat(paddingUnit, " ").concat(paddingLeft >= 0 ? paddingLeft : 70).concat(paddingUnit, " "),
