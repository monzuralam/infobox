									...
									>
											...
											<ButtonGroup id="eb-infobox-shadow-hover-ptions">
												{SHADOW_HOVER_OPTIONS.map(({ value, label }) => (
													<Button
														...
														onClick={() =>
															setAttributes({ wrp_shadowType: value })
														}
													>
														{label}
													</Button>
										...
										{wrp_shadowType === "normal" && (
											<>
												...
												<ResetControl
													onReset={() =>
														setAttributes({ wrp_hOffset: undefined })
													}
												>
													<RangeControl
												...
												<ResetControl
													onReset={() =>
														setAttributes({ wrp_vOffset: undefined })
													}
												>
													<RangeControl
												...
												<ResetControl
													onReset={() =>
														setAttributes({ wrp_spread: undefined })
													}
												>
													<RangeControl
