			...
			{wrp_shadowType === "normal" && (
				<>
					<ColorControl
						...
						onChange={(wrp_shadowColor) => setAttributes({ wrp_shadowColor })}
					/>
					...
					<ResetControl onReset={() => setAttributes({ wrp_blur: undefined })}>
						<RangeControl
				...
				<>
					...
					>
						<RangeControl
							...
							onChange={(wrp_hoverSpread) => setAttributes({ wrp_hoverSpread })}
							min={0}
							max={20}
						/>
					</ResetControl>
